...
internal static class ArabicKeyboard
{
	public static readonly LanguageKeyboard Keyboard = new LanguageKeyboard
	{
		...
		Alphabetical = new[]
		{
			new[] { "ا", "أ", "إ", "ئ", "ء", "ؤ", "آ", "ب", "ت" },
			new[] { "ة", "ث", "ج", "ح", "خ", "د", "ذ", "ر", "ز" },
			new[] { "س", "ش", "ص", "ض", "ط", "ظ", "ع", "غ", "ف" },
			new[] { "ق", "ك", "ل", "م", "ن", "ه", "و", "ي", "ى" },
			new[] { "٠", "١", "٢", "٣", "٤", "٥", "٦", "٧", "٨", "٩" }
		},
		Speed = new[]
		{
			new[] { "ا", "ل", "و", "ة", "ه", "ج", "ى", "ذ", "ء" },
			new[] { "ي", "م", "ت", "د", "أ", "ش", "خ", "ث", "ظ" },
			new[] { "ن", "ر", "ب", "س", "ك", "إ", "ض", "ئ", "ؤ" },
			new[] { "ع", "ف", "ق", "ح", "ط", "ص", "ز", "غ", "آ" },
			new[] { "٠", "١", "٢", "٣", "٤", "٥", "٦", "٧", "٨", "٩" }
		},
		// Combining marks have no shape of their own, so a literal here would be an invisible edit
		// waiting to happen — they are written by code point, named, most-used first.
		Decorators = new[]
		{
			"\u064B", // ARABIC FATHATAN
			"\u0651", // ARABIC SHADDA
